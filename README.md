...
6. **ComponentPatterns** - component design patterns
7. **ExternalTools** - external tools
8. **Hooks** - contains info and example for hooks based apps
9. **Projects** - simple demo projects
